...
if (isset($_POST['updatePayment'])) {
    ...
    if ($findDifference > 0) {
        ...
        $updateCustomerTbl = mysqli_query($connect, "UPDATE customer_add SET total_paid = (total_paid - $findDifference), total_dues = (total_dues + $findDifference) WHERE c_id = '$v_id'");
        ...
        if ($Oldpaid === $paid_amount) {
            $updateCustomersPay = mysqli_query($connect, "UPDATE customer_pay SET pay_date = '$pay_date' WHERE p_id = '$p_id'");
        } else {
            ...
            $updateCustomerTbl = mysqli_query($connect, "UPDATE customer_add SET total_paid = (total_paid + $findDifferenceAbs), total_dues = (total_dues - $findDifferenceAbs) WHERE c_id = '$v_id'");
    ...
    if (!$updateCustomersPay) {
        ...
        header("LOCATION: customer_recovery_list.php");
    }
}
...
<div class="page-content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title"><i class="fa fa-undo"></i>&nbsp;&nbsp;Customer Recovery (Edit)</h5>
            </div>
        </div>
