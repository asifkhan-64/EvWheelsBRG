...
if (isset($_POST['generate'])) {
    ...
    header("LOCATION: report_sell_view.php?start=$start&end=$end");
...
<div class="page-content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Sell Report</h5>
            </div>
        </div>
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <button type="submit" name="generate" class="btn btn-primary waves-effect waves-light">Generate Report</button>
                                </div>
                            </div>
