...
if (isset($_POST['updateCustomer'])) {
    ...
    // if ($fetch_countQuery['customers'] < 1) {
        ...
        $queryUpdateCustomer = mysqli_query(
                $connect, "UPDATE `customer_add` SET `customer_name` = '$customer_name', `customer_contact` = '$customer_contact', `customer_address` = '$customer_address', `customer_cnic` = '$customer_cnic' WHERE c_id = '$id'
                ");
...
<div class="page-content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title"><i class="fa fa-users"></i>&nbsp;&nbsp;Edit Customer</h5>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="customer_cnic" placeholder="CNIC" required="" value="<?php echo $fetch_retCustomers['customer_cnic'] ?>">
                                </div>
                            </div>
