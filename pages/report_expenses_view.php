<?php
    ...
    WHERE expense.expense_date BETWEEN '$start' AND '$end' ORDER BY expense.id ASC
        ");
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                ...
                <a href="<?php echo 'report_expense_print.php?start='.$start.'&end='.$end.''?>" rel="noopener" target="_blank" class="btn btn-success float-right btn-lg mb-3"><i class="fas fa-print"></i> Print</a>
            </div>
        </div>
        <!-- end row -->
