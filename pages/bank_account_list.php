...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title"><i class="fa fa-bank"></i>&nbsp;&nbsp;Bank Account</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
                            ...
                            <tbody>
                                ...
                                while ($rowAccounts = mysqli_fetch_assoc($retBankAcc)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="bank_account_edit.php?id=' . $rowAccounts['bank_id'] . '" type="button" class="btn text-white btn-warning waves-effect waves-light">Edit</a></td>
                                    </tr>
                                    ';
                                }
