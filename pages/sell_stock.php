...
<div class="page-content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title"><i class="fa fa-shopping-cart "></i>&nbsp;&nbsp;Sell Bike</h5>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                    $getcustomers = mysqli_query($connect, "SELECT * FROM customer_add ORDER BY customer_name ASC");

                                    echo '<select class="form-control comp" name="c_id" required>
                                    <option></option>';
                                    while ($row = mysqli_fetch_assoc($getcustomers)) {
                                        echo '<option value="' . $row['c_id'] . '">' . $row['customer_name'] . ' - ' . $row['customer_contact'] . '</option>';
                                    }
