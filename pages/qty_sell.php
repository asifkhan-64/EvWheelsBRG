...
if (isset($_POST['makeInvoice'])) {
    ...
    //     $product = $products_arr[$i];
        ...
        $insertCart = mysqli_query($connect, "INSERT INTO cart_tbl_qty(c_id, product_id, stock_id)VALUES('$c_id', '$product', '$product')");
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title"><i class="fa fa-shopping-cart "></i>&nbsp;&nbsp;Sell Bike (Bikes List)</h5>
            </div>
        </div>
                ...
                <div class="col-7" style="border-right: 1px solid grey">
                    ...
                    <div class="container" id="defaultProducts">
                        <div class="list" style="margin-top: -60px">
                            ...
                            $getStock = mysqli_query($connect, "SELECT * FROM `stock_purchase` WHERE bike_status = '1'");
